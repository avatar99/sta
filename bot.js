...
client.on('guildCreate', guild => {
  ...
  .setDescription(`**
  New Server Avatar   Community © ?
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("557181389100023839").sendEmbed(embed)
});
client.on('guildDelete', guild => {
     ...
     .setURL('https://discordapp.com/oauth2/authorize?client_id=435392018693488641&scope=bot&permissions=2146958591')
  .setDescription(`**
  Server Kicked Avatar mmunity © :cry:
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("557181389100023839").sendEmbed(embed)
});
...
if (message.author.id !== '557181389100023839') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult);
